...
const BATCH_COLUMNS = [
    ...
    render: (val) => (
      <Space>
        <Progress
          ...
          size="small"
          style={{ width: 80 }}
          strokeColor={val > 85 ? "#52c41a" : "#faad14"}
        />
  ...
  },
  {
    ...
    key: "revisionNeeded",
    render: (val) => (
      <Text type={val > 10 ? "danger" : "secondary"}>{val}%</Text>
    ),
  },
  {
    title: "Status",
    ...
    <div style={{ padding: "0 4px" }}>
      ...
      <Row justify="space-between" align="middle" style={{ marginBottom: 20 }}>
        <Col>
          ...
          <Text type="secondary">
            PM JSON-backed quality snapshot; not yet wired to live evaluation outputs
          </Text>
        </Col>
        <Col>
          <Space>
      ...
      <Alert
        ...
        description="These model quality metrics are currently static PM data for planning and design review. They are not connected to real training runs, evaluation logs, or batch QA outputs yet."
      />
          ...
          <Col span={14}>
            <Row gutter={24}>
              <Col span={8}>
                <Statistic
                  title="Precision"
                  value={QUALITY_METRICS.precision}
                  suffix="%"
            ...
            <Row gutter={24}>
              <Col span={8}>
                <Statistic
                  title="Agreement"
                  value={QUALITY_METRICS.agreement}
                  suffix="%"
              ...
              <Col span={8}>
                <Statistic
                  title="Disagreement"
                  value={QUALITY_METRICS.disagreement}
                  suffix="%"
              ...
              <Col span={8}>
                <Statistic
                  ...
                  value={QUALITY_METRICS.uncertainty}
                  suffix="%"
          ...
          >
            <div style={{ padding: "8px 0" }}>
              ...
              >
                ...
                <Text strong style={{ textAlign: "right", fontSize: 11 }}>
                  Act Syn
                </Text>
                <div
                  style={{
