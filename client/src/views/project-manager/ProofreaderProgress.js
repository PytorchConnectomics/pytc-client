  ...
  return (
    <div style={{ padding: "0 4px" }}>
      <Alert
        ...
        message="Performance cards are partially seeded"
        description="This view reflects live quota attainment, but profile cards, accuracy, and throughput remain PM-JSON analytics rather than model- or reviewer-derived telemetry."
      />
