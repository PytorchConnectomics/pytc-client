...
export PYTC_UNLOAD_OLLAMA_BEFORE_TRAINING="${PYTC_UNLOAD_OLLAMA_BEFORE_TRAINING:-0}"
...
configure_synthetic_project() {
	...
	export PYTC_INITIAL_MASK_PATH="${project_root}/data/seg/ground_truth/train-01_ground_truth.h5"
